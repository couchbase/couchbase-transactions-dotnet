...
namespace Couchbase.Transactions.DataAccess
{
    internal interface IDocumentRepository
    {
        ...
        Task<(ulong updatedCas, MutationToken mutationToken)> MutateStagedReplace(TransactionGetResult doc, object content, IAtrRepository atr);
        ...
        Task ClearTransactionMetadata(ICouchbaseCollection collection, string docId, ulong cas);
